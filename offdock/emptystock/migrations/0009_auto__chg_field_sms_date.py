...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('emptystock_sms', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Sms.date'
        db.alter_column('emptystock_sms', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
